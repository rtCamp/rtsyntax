...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Edit_jsx__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Save_jsx__ = __webpack_require__(3);
...
registerBlockType('rtsyntax/rtsyntax-block', {
	...
	edit: __WEBPACK_IMPORTED_MODULE_0__Edit_jsx__["a" /* default */],

	// Save is located inside /block/ directory
	save: __WEBPACK_IMPORTED_MODULE_1__Save_jsx__["a" /* default */]
});
...
var Edit = function (_Component) {
	...
	function Edit() {
		...
		var temp_txtarea = document.createElement('textarea');
		temp_txtarea.value = _this.props.attributes.content;
		...
		_this.state = {
			...
			contentChanged: true,
			language: _this.props.attributes.language,
			start: true,
		...
		_this.changeStateContent = _this.changeStateContent.bind(_this);
		_this.handleTabKey = _this.handleTabKey.bind(_this);
		_this.getHighlightedCode = _this.getHighlightedCode.bind(_this);
	...
	_createClass(Edit, [{
		key: 'changeStateContent',
		value: function changeStateContent(e) {
		...
		value: function getHighlightedCode() {
			...
			if (worker !== null) {
				...
				var nonworker_content = hljs.highlight(language, content);
		...
		value: function updateAttrContent() {
			var _this2 = this;
			...
			this.getHighlightedCode(state.content, state.language, function (status) {
				var language = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
				var content = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
				var html_content = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
				var worker = arguments[4];
