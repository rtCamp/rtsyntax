...
# main config
PLUGINSLUG="rtsyntax"  #must match with wordpress.org plugin slug
MAINFILE="rtsyntax.php" # this should be the name of your main php file in the wordpress plugin
